...
export const FetchNewsApi = {
  fetchNewsApi: async () => {
    const res = await fetch(
      "https://newsapi.org/v2/everything?q=india&from=2023-12-24&sortBy=publishedAt&apiKey=14f983db36fd4f20a142b8c4b22c47cf"
    );
  ...
  fetchNewsApiByQuery: async (query) => {
    const res = await fetch(
      `https://newsapi.org/v2/everything?q=${query}&from=2023-12-24&sortBy=publishedAt&apiKey=14f983db36fd4f20a142b8c4b22c47cf`
    );
    const results = await res.json();
    return results.articles;
  },
